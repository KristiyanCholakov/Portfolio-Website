                ...
                <div className="space-y-2">
                  {experience.map((job, index) => (
                    <motion.button
                      ...
                      className={`flex w-full items-center border-l-2 px-4 py-3 text-left transition-all ${
                        activeJob === job.id
                    ...
                    >
                      ...
                      <div className="ml-3 flex-1">
                        ...
                        <div className="text-xs opacity-70">{job.company}</div>
                      </div>
                      <div className="text-xs opacity-60">{job.period}</div>
                    </motion.button>
                  ))}
                </div>
              </div>
          ...
          >
            {experience.map(job => (
              <motion.div
                ...
                animate={{
                  opacity: activeJob === job.id ? 1 : 0,
                  display: activeJob === job.id ? 'block' : 'none',
                }}
                transition={{ duration: 0.4 }}
                className="h-full"
              >
                <div className="border-accent/10 h-full overflow-hidden rounded-xl border">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {job.technologies.map((tech, i) => (
                          ...
                          >
                            <Code size={14} className="text-accent" style={{ color: job.color }} />
                            {tech}
                          </motion.div>
                        ))}
                      </div>
